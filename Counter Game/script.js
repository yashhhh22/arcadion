...
const increaseSound = "/Counter Game/sounds/increase.mp3";
const decreaseSound = "/Counter Game/sounds/decrease.mp3";
const resetSound = "/Counter Game/sounds/reset.mp3";
